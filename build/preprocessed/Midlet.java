...
public class Midlet extends MIDlet implements CommandListener, DiscoveryListener {
    ...
    String key1="";
    Alert a=null;
    String movekey[]={"Tab","Back","Down","Up","Right","Left","Ok","Select All","App-Menubar","FileOption","Escape"};
    String firefox[]={"Run Browser","Home","New Tab","Close Tab","Next Tab","Refresh","Back","Add Bookmark","Zoom Out","Zoom In","Scroll Down","Scroll Up"};
    String key[]={"Start","Selection Keys","Switch Application","Close"};
    String media[]={"Run Player","Open Files","Selection keys","Play/Pause","Previous","Next","Volume Up","Volume Down","Forward","Mute","Exit"};
    String power[]={"Run PowerPoint","Open File","Selection Keys","Exit Slideshow","Next Slide","Previous Slide","Exit"};
//used as an indicator to the device queried for
//the echo server

    public void startApp() {
        searchdevice = new List("Device Search", Choice.IMPLICIT); //the main menu
    ...
    public void FindServices(RemoteDevice device) {
        try {
           ...
           uuids[0] = new UUID("00000102030405060740A1B1C1D1E100",false); //The UUID of the ech service
